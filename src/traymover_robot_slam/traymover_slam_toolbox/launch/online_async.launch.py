"""Launch slam_toolbox (async) for the Traymover chassis.

Brings up the traymover base driver with the lidar + EKF enabled, flattens the
Leishen point cloud to /scan, and starts async_slam_toolbox_node with the
parameters in config/mapper_params_online_async.yaml.
"""
import os
...
def generate_launch_description():
    ...
    default_params_file = os.path.join(
        slam_pkg, 'config', 'mapper_params_online_async.yaml')
